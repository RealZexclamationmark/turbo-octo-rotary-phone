onEvent("recipes", (event) => {
  ...
  ftbsbtools
    ...
    ftbsbtools
    .crook("minecraft:slime_block", [
      Item.of("tconstruct:ender_slime_vine").withChance(0.3),
      Item.of("tconstruct:sky_slime_vine").withChance(0.3),
      Item.of("tconstruct:earth_slime_grass_seeds").withChance(0.25),
      Item.of("tconstruct:sky_slime_grass_seeds").withChance(0.25),
      Item.of("tconstruct:ichor_slime_grass_seeds").withChance(0.25),
      Item.of("tconstruct:ender_slime_grass_seeds").withChance(0.25),
      Item.of("tconstruct:blood_slime_grass_seeds").withChance(0.25),
      Item.of("tconstruct:earth_slime_sapling").withChance(0.15),
      Item.of("tconstruct:sky_slime_sapling").withChance(0.15),
      Item.of("tconstruct:ender_slime_sapling").withChance(0.15),
    ])
    .max(1);
